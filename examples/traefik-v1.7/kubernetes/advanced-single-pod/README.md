...
This example uses [Global Authentication](https://github.com/priyankub/traefik-forward-auth-secure/blob/master/README.md#global-authentication) to apply authentication for the entire `https` entrypoint.
